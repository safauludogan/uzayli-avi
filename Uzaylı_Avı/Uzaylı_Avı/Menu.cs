...
{
    public partial class Menü2 : Form
    {
        ...
        int uzaylilar = 0, İkiOyuncu = 0, s = 0, s2 = 0;
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            if (uzaylilar == 1)
            {
                ...
                label14.Visible = true;
                textBox3.Visible = true;
                if (textBox3.Text == "" && s >= 2)
                {
                    MessageBox.Show("Lütfen Oyuncu İsminizi Giriniz");
                }
                else if (sayac3 == 1) 
                {
                    this.Hide();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (İkiOyuncu == 1)
            {
                ...
                if (textBox1.Text == "" && textBox2.Text == "" && s2 >= 2) 
                {
                    MessageBox.Show("Lütfen Oyuncu İsimlerini Giriniz");
                }
